...
public class StatusBar extends CordovaPlugin {
  ...
  public void initialize(final CordovaInterface cordova, CordovaWebView webView) {
    ...
    activity.runOnUiThread(() -> {
      ...
      setStatusBarTransparent(preferences.getBoolean("StatusBarOverlaysWebView", true), null);
  ...
  public boolean execute(final String action, final CordovaArgs args, final CallbackContext callbackContext) {
    ...
    switch (action) {
      ...
      case ACTION_OVERLAYS_WEB_VIEW:
        activity.runOnUiThread(() -> {
          try {
            setStatusBarTransparent(args.getBoolean(0), callbackContext);
          } catch (JSONException ignore) {
  ...
  private void setStatusBarTransparent(final boolean isTransparent, final CallbackContext callbackContext) {
